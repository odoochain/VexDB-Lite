...
#define DISTANCE_FUNC_NAME(name)  SME2V9_FUNC(name)
#define DISTANCE_STRUCT_NAME(name) SME2V9_STRUCT(name)
#define __NEON_SUPPORT__
#define __SVE_SUPPORT__
#define __SVE2_SUPPORT__
#define __SME_SUPPORT__
#define __SME2_SUPPORT__
