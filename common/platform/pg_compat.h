...
/* Aligned allocation — openGauss mem_align_alloc/mem_align_free compat */
#define mem_align_alloc(align, size) palloc_aligned((size), (align), 0)
#define mem_align_free(ptr)          pfree(ptr)
