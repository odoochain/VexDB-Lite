...
public:
    ...
    static BlockNumber get_freespace_meta(Relation rel, bool is_wal, ForkNumber fork_num = MAIN_FORKNUM)
        { return DiskVector<T>::get_disk_vector(rel, is_wal, fork_num); }
