...
vexdb_vector_init_guc(void)
{
    ...
    /* GUC parameters */
    DefineCustomIntVariable("vex.ef_search",
    ...
    DefineCustomBoolVariable("vex.enable_vec_buffer_manager",
    ...
    DefineCustomIntVariable("vex.vector_buffers",
    ...
    DefineCustomIntVariable("vex.vector_buffer_workers",
    ...
    DefineCustomStringVariable("vex.vec_architecture",
